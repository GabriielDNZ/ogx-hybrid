...
void XInputDevice::process(const uint8_t idx, Gamepad& gamepad)
{
    ...
    {
        // HIBRIDO: receber um comando de RUMBLE do host e a prova mais
        // confiavel de que estamos conectados a um Xbox de verdade (o
        // PS5 nunca vai mandar esse comando, pois nao tem driver
        // XInput). Confirma ao bootloader que o modo CONTROLE
        // funcionou, para ele ser preferido no proximo boot.
