...
int main() {
    ...
    // HIBRIDO: este watchdog proprio (2s, mais agressivo que o padrao
    // de 8s usado no app de controle) ja cumpre o papel de "se travar,
    // reinicia e deixa o bootloader tentar de novo / eventualmente
    // alternar de modo". Nao precisamos de boot_confirm_arm_watchdog()
    // aqui -- so existe UM watchdog de hardware no chip.
